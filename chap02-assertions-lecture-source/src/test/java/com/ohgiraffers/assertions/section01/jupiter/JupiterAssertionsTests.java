...
class JupiterAssertionsTests {
    ...
    * 모든 jupiter assertions의 메소드는 정적(static) 메소드 형태로 제공하고 있따.
    * */
...
//        Assertions.assertEquals(result, num2 == num1);
    ...
    * */
    ...
    void testAssertThrows(){
        ...
        int firstNum = 10;
        int secondNum = 0;
        String execeptedErrorMessage =  "0으로 나눌 수 없습니다.";
...
//        );
        ...
        Assertions.assertAll(
                ...
                () -> Assertions.assertEquals(execeptedErrorMessage, exception.getMessage())
        );
    }
