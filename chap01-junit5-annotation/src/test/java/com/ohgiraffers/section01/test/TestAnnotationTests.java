...
public class TestAnnotationTests {
    ...
    * */
    ...
    /*
    * 기본적인 테스트 메소드를 만들기 위해 사용하는 어노테이션 이다.
    ...
    * */
    ...
    public void 테스트_메소드2(){
        /*
        * 클래스 레벨 @DisplayNameGenerator를 붙이게 되면 언더바를 공백으로 처리하여 테스트 이름을 부여해준다ㅣ.
        * 단, @DispalyName과 중복 작성 시에는 @DisplayName에 부여한 테스트 이름이 우선권을 가진다.
        * */
    }
